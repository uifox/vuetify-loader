...
const vuetifyRootPath = join(require.resolve('@uifox-at-doxo/vuetify/es5/components'), '../../..')
...
const directives = Object.keys(require('@uifox-at-doxo/vuetify/es5/directives'))
  .filter(val => val !== 'default')

const dir = dirname(require.resolve('@uifox-at-doxo/vuetify/es5/components'))
...
readdirSync(dir).forEach(group => {
  ...
  const component = require(`@uifox-at-doxo/vuetify/es5/components/${group}`).default
  ...
  decache(`@uifox-at-doxo/vuetify/es5/components/${group}`)
})
